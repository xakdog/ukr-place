...
const sizeOptions: Record<SpinnerProps["size"], string> = {
  "2xl": "w-16 h-16",
};

export const Spinner: React.FC<SpinnerProps> = ({ size }) => {
  const sizeStyle = sizeOptions[size];

  return (
    <svg
      role="status"
      className={`${sizeStyle} text-gray-200 animate-spin dark:text-gray-600 fill-indigo-600`}
      viewBox="0 0 100 101"
      fill="none"
    ...
    >
      <path
        d="
          ...
          73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987
      ...
      <path
        d="
          M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167
