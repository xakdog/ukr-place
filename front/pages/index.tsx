  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="A crypto game inspired by Reddit place. You can buy ink and paint pixels. Money transferred directly to charity organisations, we don't take any cut." />
